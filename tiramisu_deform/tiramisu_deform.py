...
import sys
sys.path.append('/home/yangle/software/anaconda2/envs/pt_deform/deformable-convolution/')
...
class TransitionDown(nn.Sequential):
	...
	def forward(self, x):
		out = self.prelu(self.norm(x))
		out = self.maxpool(self.drop(self.conv(out)))
		return out
...
def FcDnSubtle(in_channels=3, n_classes=2):
    return FCDenseNet(in_channels=in_channels, down_blocks=(4,4,4),
