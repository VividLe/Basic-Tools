...
res_mask_rp = '/home/yangle/TCyb/dataset/tiramisu_6ch_std/trainannot/'
res_img_rp = '/home/yangle/TCyb/dataset/tiramisu_6ch_std/train/'
res_cont_rp = '/home/yangle/TCyb/dataset/tiramisu_6ch_std/traincont/'

if not os.path.exists(res_mask_rp):
    os.makedirs(res_mask_rp)
if not os.path.exists(res_img_rp):
    os.makedirs(res_img_rp)
if not os.path.exists(res_cont_rp):
...
# for iimg in range(1):
    ...
    for iord in range(num_sel):
        ...
        utils.save_cont(box, cont, img, name_img_pre, res_cont_rp)
